...
Some Minimal Notes on Notation and Minima. **Maxwell J D Ramstead**\* and **Dalton A R Sakthivadivel**\*. May 2022. [Preprint](https://arxiv.org/abs/2204.13576). [Link](https://doi.org/10.1016/j.plrev.2022.05.005). [PDF]({{{ site.files }}}/files/MJDR Phys Life Rev 2022 (proofs).pdf).    
