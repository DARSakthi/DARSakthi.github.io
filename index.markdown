...
For a summary of my current research, see [this page (/research)](https://darsakthi.github.io/research). I am broadly interested in the machinery surrounding irregularity in topology and how it threads through complementary areas of algebra, analysis, arithmetic, and occasionally others. My primary research programme is devoted to (non-equilibrium) statistical field theory and the analysis of stochastic partial differential equations: the properties of spaces of functions studied _via_ techniques from global analysis, probability in infinitely-many dimensions, harmonic analysis and Hodge theory on irregular domains, and most significantly the probability and statistical physics of strongly interacting particle systems. I am most often motivated by objects or questions in mathematical and statistical physics. Quantum field theories of various sorts, renormalisation and scaling limits, and the use of function space integrals feature heavily in my work as rich objects living in the intersection of these areas. 
