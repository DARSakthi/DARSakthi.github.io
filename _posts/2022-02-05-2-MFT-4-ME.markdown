...
$$ \ln\{Z(x\mid y)\} \geq \ln\{Z_q(x; \lambda)\} - \langle \hat H(x \mid y) - \hat H_q(x ; \lambda)) \rangle_q \iff D_{KL}( q(x;\lambda), p(x \mid y) \geq 0 $$ 
...
$$ \ln\{Z_{\mid y})\} \geq \ln\{Z_q\} - \langle \ln\{ Z_{\mid y} p(x \mid y) \} \rangle_q + \langle \ln\{Z_q q_\lambda(x) \} \rangle_q $$

$$\ln\{Z_{\mid y})\} \geq \ln\{Z_q\} - \left\langle \ln\left\{ Z_{\mid y} \frac{p(x,y)}{p(y)} \right\} \right\rangle_q + \langle Z_q \ln\{q_\lambda(x) \} \rangle_q$$

$$0 \geq - \left\langle \ln\left\{ \frac{p(x,y)}{p(y)} \right\} \right\rangle_q + \langle \ln\{q_\lambda(x) \} \rangle_q$$

$$0 \geq - D_{KL}( q_\lambda(x) \| p(x,y) ) + \ln\{p(y)\}.$$
