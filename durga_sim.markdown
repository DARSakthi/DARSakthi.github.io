...
<head>
    ...
    <title>DURGA Attractor Basin Simulation</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .layer-info .neural { color: #E07A5F; }
        .layer-info .symbolic { color: #8D99AE; }
        .layer-info .coupling { color: #4A5C6A; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="main-grid">
            <div class="canvas-container">
                ...
                <div class="layer-info">
                    <div><span class="neural">●</span> Neural Layer (Pattern Recognition)</div>
                    <div><span class="symbolic">●</span> Symbolic Layer (Validation)</div>
                    <div><span class="coupling">●</span> Recurrent Coupling</div>
                </div>
            </div>
            
            <div class="sidebar">
                <div class="controls-panel">
                    <h3 style="color: #E07A5F; margin-bottom: 15px;">Simulation Controls</h3>
                    
                    <button class="btn-primary" onclick="spawnBatch()">Spawn Particle Batch</button>
                    <button class="btn-secondary" onclick="toggleSimulation()" id="toggleBtn">Pause</button>
                    ...
                    <div class="control-group">
                        <label>Spawn Rate <span class="value-display" id="spawnRateVal">5</span></label>
                        <input type="range" id="spawnRate" min="1" max="20" value="5" oninput="updateParam('spawnRate', this.value)">
                    </div>
                    
                    <div class="control-group">
                        <label>Attractor Strength <span class="value-display" id="attractorStrengthVal">1.0</span></label>
                        <input type="range" id="attractorStrength" min="0.5" max="3" step="0.1" value="1" oninput="updateParam('attractorStrength', this.value)">
                    </div>
                    
                    <div class="control-group">
                        <label>Friction <span class="value-display" id="frictionVal">0.92</span></label>
                        <input type="range" id="friction" min="0.8" max="0.99" step="0.01" value="0.92" oninput="updateParam('friction', this.value)">
                    </div>
                    
                    <div class="control-group">
                        <label>Noise Level <span class="value-display" id="noiseVal">0.1</span></label>
                        <input type="range" id="noise" min="0" max="0.5" step="0.05" value="0.1" oninput="updateParam('noise', this.value)">
                    </div>
                    
                    <div class="toggle-container">
                        <label class="toggle-switch">
                            <input type="checkbox" id="showField" checked onchange="toggleField()">
                            <span class="toggle-slider"></span>
                        </label>
                        <span class="toggle-label">Show Potential Field</span>
                    </div>
                    
                    <div class="toggle-container">
                        <label class="toggle-switch">
                            <input type="checkbox" id="showTrajectories" checked onchange="toggleTrajectories()">
                            <span class="toggle-slider"></span>
                        </label>
                        <span class="toggle-label">Show Trajectories</span>
                    </div>
                    
                    <div class="toggle-container">
                        <label class="toggle-switch">
                            <input type="checkbox" id="autoSpawn" onchange="toggleAutoSpawn()">
                            <span class="toggle-slider"></span>
                        </label>
                        <span class="toggle-label">Auto Spawn</span>
                    </div>
                </div>
                ...
                <div class="stats-panel">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="stat-value" id="inFlight">0</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-label">Feedback Loops</span>
                        <span class="stat-value" id="feedbackLoops">0</span>
                    </div>
                </div>
                
                <div class="basin-legend">
                    <div class="basin-item">
                        <div class="basin-color" style="background: #E07A5F;"></div>
                        <span class="basin-name">Assertion</span>
                        <span class="basin-count" id="assertionCount">0</span>
                    </div>
                    <div class="basin-item">
                        <div class="basin-color" style="background: #8D99AE;"></div>
                        <span class="basin-name">Context</span>
                        <span class="basin-count" id="contextCount">0</span>
                    </div>
                    <div class="basin-item">
                        <div class="basin-color" style="background: #4A5C6A;"></div>
                        <span class="basin-name">Evidence</span>
                        <span class="basin-count" id="evidenceCount">0</span>
                    </div>
                    <div class="basin-item">
                        <div class="basin-color" style="background: #E07A5F;"></div>
                        <span class="basin-name">Contrast</span>
                        <span class="basin-count" id="contrastCount">0</span>
                    </div>
                    <div class="basin-item">
                        <div class="basin-color" style="background: #8D99AE;"></div>
                        <span class="basin-name">Gap</span>
                        <span class="basin-count" id="gapCount">0</span>
                    </div>
                    <div class="basin-item">
                        <div class="basin-color" style="background: #4A5C6A;"></div>
                        <span class="basin-name">Entity</span>
                        <span class="basin-count" id="entityCount">0</span>
                    </div>
                </div>
